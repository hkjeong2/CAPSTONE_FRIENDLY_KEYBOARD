...
//import com.example.friendlykeyboard.keyboard.CandidateView
//
///**
...
// */
//class SoftKeyboard : InputMethodService(), OnKeyboardActionListener {
//    private var mInputMethodManager: InputMethodManager? = null
//    private var mInputView: LatinKeyboardView? = null
//    private var mCandidateView: CandidateView? = null
//    private var mCompletions: Array<CompletionInfo>?
...
//     *
//     * Note that before [android.os.Build.VERSION_CODES.KITKAT], there is no way to support
//     * multi-display scenarios, so the context object will just return the IME context itself.
//     *
//     * With initiating multi-display APIs from [android.os.Build.VERSION_CODES.KITKAT], the
//     * context object has to return with re-creating the display context according the metrics
//     * of the display in runtime.
//     *
//     * Starts from [android.os.Build.VERSION_CODES.S_V2], the returning context object has
...
//        }
//        mQwertyKeyboard = LatinKeyboard(displayContext, R.xml.qwerty)
//        mSymbolsKeyboard = LatinKeyboard(displayContext, R.xml.symbols)
//        mSymbolsShiftedKeyboard = LatinKeyboard(displayContext, R.xml.symbols_shift)
//    }
//
//    /**
...
//            && mInputView != null
//        ) {
//            val current: Keyboard = mInputView.getKeyboard()
...
//                primaryCode = primaryCode.uppercaseChar().code
//            }
//        }
